...
# 1.32.11
RUN wget https://openui5.hana.ondemand.com/downloads/openui5-runtime-1.32.11.zip -P /var/www/html
RUN unzip -o /var/www/html/openui5-runtime-1.32.11.zip -d /var/www/html/
RUN rm /var/www/html/openui5-runtime-1.32.11.zip
# 1.30.11
...
# 1.28.27
RUN mkdir /var/www/html/1.28.27
RUN wget https://openui5.hana.ondemand.com/downloads/openui5-runtime-1.28.27.zip -P /var/www/html
RUN unzip -o /var/www/html/openui5-runtime-1.28.27.zip -d /var/www/html/1.28.27
RUN rm /var/www/html/openui5-runtime-1.28.27.zip
# 1.26.16
