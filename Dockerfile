...
# 1.28.25
RUN mkdir /var/www/html/1.28.25
RUN wget https://openui5.hana.ondemand.com/downloads/openui5-runtime-1.28.25.zip -P /var/www/html
RUN unzip -o /var/www/html/openui5-runtime-1.28.25.zip -d /var/www/html/1.28.25
RUN rm /var/www/html/openui5-runtime-1.28.25.zip
# 1.26.16
